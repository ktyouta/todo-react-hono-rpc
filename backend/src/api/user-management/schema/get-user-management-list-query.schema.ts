...
/**
 * ユーザー一覧取得クエリパラメータスキーマ（管理者用）
 */
export const GetUserManagementListQuerySchema = z.object({
...
export type GetUserManagementListQuerySchemaType = z.infer<typeof GetUserManagementListQuerySchema>;
