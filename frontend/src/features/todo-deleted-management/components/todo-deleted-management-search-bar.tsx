...
type PropsType = {
    ...
    onChange: (searchCondition: TodoDeletedManagementSearchFilter) => void;
    onSearch: () => void;
    onClear: () => void;
...
export function TodoDeletedManagementSearchBar({ searchCondition, onChange, onSearch, onClear, userList, categoryList, statusList, priorityList, handleKeyPress }: PropsType) {
