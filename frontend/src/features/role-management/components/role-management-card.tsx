...
type PropsType = {
    entry: RoleManagementListReturnType['list'][number];
    onClick: () => void;
};

export function RoleManagementCard({ entry, onClick }: PropsType) {
    return (
        <div
        ...
        >
            <div className="flex items-start justify-between gap-3">
                <p className="text-[17px] font-medium text-gray-800 dark:text-gray-100 break-words min-w-0">{entry.name}</p>
