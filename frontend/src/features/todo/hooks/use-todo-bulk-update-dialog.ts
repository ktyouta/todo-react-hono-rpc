...
import { BulkUpdateFormValues } from "./use-todo-bulk";
...
export function useTodoBulkUpdateDialog({ categoryList, statusList, priorityList, onClose, onConfirm }: PropsType) {
