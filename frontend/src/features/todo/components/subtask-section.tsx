...
const columns: TableProps<SubtaskListDataType[number]>['columns'] = [
    ...
    { title: 'ステータス', field: 'statusName', className: 'w-[9%] whitespace-nowrap', Cell: ({ entry }) => <Badge label={entry.statusName} bgColor={entry.statusId != null ? STATUS_COLOR_MAP[entry.statusId] : undefined} /> },
    { title: '優先度', field: 'priorityName', className: 'w-[9%] whitespace-nowrap', Cell: ({ entry }) => <Badge label={entry.priorityName} bgColor={entry.priorityId != null ? PRIORITY_COLOR_MAP[entry.priorityId] : undefined} /> },
    {
