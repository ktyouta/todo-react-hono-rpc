...
import { useBulkRestoreTodoTrashMutation } from "../api/bulk-restore-todo-trash";
...
export function useTodoTrashBulk({ taskData }: PropsType) {
    ...
    // 一括復元ミューテーション
    const bulkRestoreMutation = useBulkRestoreTodoTrashMutation({
        onSuccess: (data) => {
...
export type UseTodoTrashBulkReturn = ReturnType<typeof useTodoTrashBulk>;
